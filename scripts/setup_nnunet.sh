#!/bin/bash
# This script sets up the nnUNet environment and runs the preprocessing and 
# dataset integrity verification. Afterward, the nnUNet environment is ready
# for training and preprocessed dataset can be checked in nnUNet_preprocessed/
